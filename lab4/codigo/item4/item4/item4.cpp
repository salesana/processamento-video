...
int main(int argc, char** argv)
{
 //! [Open webcam]
	...
	Mat equalized_red, equalized_green, equalized_blue;
       	...
       	vector<Mat> equalizedChannels = {equalized_red, equalized_green, equalized_blue};
       	//vector<Mat> equalizedChannels = {equalized_blue, equalized_green, equalized_red};
       	Mat img_final;
       	merge(equalizedChannels, img_final);
       	//cvtColor(img_final_rgb, img_final_bgr, COLOR_BGR2RGB);
	...
	*/
	   ...
	   imshow("Img_final", 	img_final);
        ...
        if (key == 's' || key == 'S')
        {
            ...
            imwrite("Imagem_Equalizada.png", img_final);
